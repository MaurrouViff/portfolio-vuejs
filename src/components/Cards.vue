<template>
  <div>
    <section class="flex items-center justify-center bg-slate-500 min-h-[600px]">
      <div class="grid grid-cols-1 tablet:gap-4 laptop:gap-5 desktop:gap-6 tablet:grid-cols-2 laptop:grid-cols-2 desktop:grid-cols-3">
        <!-- Carte 1 -->
